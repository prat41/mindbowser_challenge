          ...
          {props.loggedIn ? (
            <Fragment>
              <ul className="navbar-nav mr-auto">
                <li className={"nav-item " + (pathname === '/add-employee' ? 'active' : '')}>
                  <NavLink isActive={checkActive} to="/add-employee" className="nav-link">Add Product</NavLink>
                </li>
                <li className={"nav-item " + (pathname === '/list-employee' ? 'active' : '')}>
                  <NavLink isActive={checkActive} to="/list-employee" className="nav-link">Employee List</NavLink>
                </li>
              ...
              <Fragment>
                <ul className="navbar-nav ml-auto">
                  ...
                  <li className={"nav-item " + (pathname === '/add-employee' ? 'active' : '')}>
                    <NavLink isActive={checkActive} to="/add-employee" className="nav-link">Add Employee</NavLink>
                  </li>
                  <li className={"nav-item " + (pathname === '/list-employee' ? 'active' : '')}>
                    <NavLink isActive={checkActive} to="/list-employee" className="nav-link">Employee List</NavLink>
                  </li>
