                        ...
                        <div className="col-sm-8">
                            <div className="card">
                                ...
                                <div className="form-group">
                                        ...
                                        <input type="text" required name="firstname" onChange={this.handleInput} className="form-control" placeholder="Enter Firstname" />
                                    </div>
                                    <div className="form-group">
                                        <label >last Name</label>
                                        <input type="text" required name="lastname" onChange={this.handleInput} className="form-control" placeholder="Enter lastname" />
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <label >Company</label>
                                        <input type="text" required name="Company" onChange={this.handleInput} className="form-control" placeholder="Enter Company" />
                                    </div>

                                    <div className="form-group">
                                        <label >DOB</label>
                                        <input type="date" required name="DOB" onChange={this.handleInput} className="form-control" placeholder="Enter DOB" />
                                    </div>

                                    <div className="form-group">
                                        <label >Address</label>
                                        <input type="text" required name="name" onChange={this.handleInput} className="form-control" placeholder="Enter Address" />
                                    </div>
